...
echo $t = New-ScheduledTaskTrigger -AtLogOn -User $env:USERNAME >> "%PS%"
echo $s = New-ScheduledTaskSettingsSet -MultipleInstances IgnoreNew -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries -Priority 4 -ExecutionTimeLimit ^([System.TimeSpan]::Zero^) >> "%PS%"
